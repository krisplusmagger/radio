...
# Title: WiFi+ZigBee timed-burst sync TX (no ACK, rate-capped)
...
class wifi_zigbee_sync_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "WiFi+ZigBee timed-burst sync TX (no ACK, rate-capped)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("WiFi+ZigBee timed-burst sync TX (no ACK, rate-capped)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "wifi_zigbee_sync_tx")
        ...
        self._pkt_rate_range = qtgui.Range(1, max_pkt_rate, 1, 57, 200)
        ...
        self.zigbee_tx.set_time_unknown_pps(uhd.time_spec(0))
        ...
        self.wifi_tx.set_time_unknown_pps(uhd.time_spec(0))
        ...
        self.customModule_getSignal_1 = customModule.getSignal( 1, gr.sizeof_gr_complex, "1111.txt", "wifi_start_detect.txt")
        self.customModule_getSignal_0_1 = customModule.getSignal( 1, gr.sizeof_gr_complex, "uselssdsadasdass.txt", "wifi_long_detect.txt")
        self.customModule_getSignal_0_0 = customModule.getSignal( 1, gr.sizeof_gr_complex, "uselss.txt", "packtet_num_zigbee.txt")
        self.customModule_getSignal_0 = customModule.getSignal( 1, gr.sizeof_gr_complex, "uselss.txt", "packtet_num_wifi.txt")
        ...
        self.connect((self.ieee802_15_4_oqpsk_phy_0, 0), (self.customModule_getSignal_0_0, 0))
        self.connect((self.ieee802_15_4_oqpsk_phy_0, 0), (self.zigbee_tx, 0))
        ...
        self.connect((self.wifi_phy_hier_0, 0), (self.customModule_getSignal_0, 0))
        self.connect((self.wifi_phy_hier_0, 2), (self.customModule_getSignal_0_1, 0))
        self.connect((self.wifi_phy_hier_0, 1), (self.customModule_getSignal_1, 0))
        self.connect((self.wifi_phy_hier_0, 0), (self.wifi_tx, 0))
    ...
    def set_samp_rate_zig(self, samp_rate_zig):
        ...
        self.set_max_pkt_rate(int(self.samp_rate_zig/3336))
        self._samp_rate_zig_callback(self.samp_rate_zig)
        self.zigbee_tx.set_samp_rate(self.samp_rate_zig)

    def get_tx_window(self):
        return self.tx_window

    def set_tx_window(self, tx_window):
        self.tx_window = tx_window

    def get_tx_lead(self):
        return self.tx_lead

    def set_tx_lead(self, tx_lead):
        self.tx_lead = tx_lead
    ...
    def get_pkt_rate(self):
        return self.pkt_rate

    def set_pkt_rate(self, pkt_rate):
        self.pkt_rate = pkt_rate
        self.blocks_message_strobe_0.set_period((int(1000.0/self.pkt_rate)))

    def get_max_pkt_rate(self):
        return self.max_pkt_rate

    def set_max_pkt_rate(self, max_pkt_rate):
...
def main(top_block_cls=wifi_zigbee_sync_tx, options=None):
